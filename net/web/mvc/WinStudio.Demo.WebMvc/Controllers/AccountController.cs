...
using WinStudio.Demo.WebMvc.Filters;
using WinStudio.Demo.WebMvc.Models;

namespace WinStudio.Demo.WebMvc.Controllers
{
    [Authorize]
    [InitializeSimpleMembership]
    public class AccountController : Controller
    {
        [Import(typeof(IContactorProxy))]
        public IContactorProxy contactor { get; set; }
        [ImportingConstructor]
        public AccountController(IContactorProxy proxy)
        {
            contactor = proxy;
        }
        //
        ...
        {
            if (ModelState.IsValid && contactor.ExistContactor(model.UserName))// WebSecurity.Login(model.UserName, model.Password, persistCookie: model.RememberMe))
            {
