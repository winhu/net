        ...
        {
            {
                ...
                try
                {
                    //var ass = Assembly.LoadFrom(@"D:\synjones\code\svn\dream3\web\ui\Synjones.Dreams.Web\bin\Card\Synjones.Dreams.Plugins.Card.dll");
                    //var types = ass.GetTypes();
                    //var types = Assembly.Load(assemblyname).GetTypes();
                    //var asses = Utility.GetAssembly(assemblyname);
